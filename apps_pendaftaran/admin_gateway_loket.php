<?php
    	...
    	if((isset($_POST['next_current']) || isset($_POST['next_repeat']) || isset($_POST['next_absen'])) && (($_POST['next_current'] != NULL) || ($_POST['next_repeat'] != NULL) || ($_POST['next_absen'] != NULL))){
            ...
            $sql = "SELECT id as count, nomor, nomor_lama, kodebooking FROM data_antrian WHERE  STATUS = 3 ". $sql_loket . $filter_waktu . $filter_jenis_antrian . " ORDER BY id LIMIT 1";
            //echo $sql.'<p>';
    		...
    		if($rowClient['count']){
				...
				$kodebooking     = $rowClient['kodebooking'];					
