...
$jaminan = $response_data->data;
												...
												<tr>
													<td colspan="2">														
														...
														<label for="Loket3"><span><span></span></span>POLIKLINIK GIGI DAN ANAK</label>
								...
								<div id='show-loket1' style='display:none'>Loket 1 : Dr.Abcd</div>
								<div id='show-loket2' style='display:none'>Loket 2 : Dr.XYZ</div>
								<div id='show-loket3' style='display:none'>Loket 3 : Dr.LMN</div>
								<div id='show-loket4' style='display:none'>Loket 4 : Dr.RST</div>
...
<script languange="javascript">
	...
	$(".rg").change(function () {	
		...
		if ($('#loket1').attr('checked')) {
			$('#show-loket1').show();
			// $("#nomor_loket").val() = "LOKET 1";
			// $("#nama_dokter").val() = "DR. ABCD";
			 //jQuery('#nomor_loket').val() = "LOKET Nomor 1";
			// jQuery('#nama_dokter').val() = "ACCCC";

			//objfrm.getElementById("nomor_loket") = "LOKET Nomor 1";
			//alert(jQuery('#nomor_loket').val())
