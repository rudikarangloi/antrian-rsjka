...
<html lang="en">
  ...
  <head>
    ...
    <title>Sistem Antrian <?php echo $CLIENTNAME;?></title>
  ...
  <body>
    ...
    <!-- Masthead -->
	 ...
	 <div class="jumbotron jumbotron">
            <div class="container text-center">
				...
				<h2>ANTRIAN <?php echo $CLIENTNAME;?></h2>
            </div>
        </div>
    ...
    <section class="features-icons bg-light text-center">
      ...
      <!-- Ditambahkan menu baru untuk Pendaftaran peserta baru khusus BPJS -->
		   <div class="col-lg-4">
            <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
              <a href="form_pendaftaran_bpjs.php">
                <div class="features-icons-icon d-flex">
                  <i class="icon-camera m-auto text-primary"></i>
                </div>
              </a>
              <h3><a href="form_pendaftaran_bpjs.php">Pendaftaran Pasien Baru BPJS</a></h3>
              <p class="lead mb-0"></p>
            </div>
          </div>
