...
<body>
  ...
  <nav class="navbar navbar-light bg-light static-top">
    <div class="container">
      ...
      <a class="navbar-brand" href="#">Sistem Antrian <?php echo $CLIENTNAME;?></a>
          ...
          <form name="myfrm" method="POST" action="form_input_data.php">		     
            ...
            <div class="form-row">
              ...
              <div class="col-12 col-md-9 mb-2 mb-md-0">
                <input type="text" name="input_data" id="input_data" class="form-control form-control-lg" placeholder="Masukan Nomor NIK atau Rekam Medis"
                  required>
              </div>
    ...
    $("document").ready(function () {
      ...
      $(".btn").click(function () {
        ...
        if (input_data == '') {
          ...
          $.post("<?php echo $url_api;?>konfirmasi_pasien.php", {       		  
