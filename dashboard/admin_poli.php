		...
		$("document").ready(function()
		{
			...
			$(".next_getway").click(function(){			
				...
				$.post( "../apps/admin_getway_poli.php",{"next_current": next_current,"next_repeat": next_repeat,"nomor_loket": nomor_loket}, function( data ) {
					...
					$(".next").html(data['next']);
					$("#nama_pasien").html(data["init_nama_queque"]);
					console.log(data["init_nama_queque"] + ' => ' + data["init_kodeBooking_queque"]);
					kodeBooking = data["init_kodeBooking_queque"];
					taskid = "4";
			...
			setInterval(function() {
				...
				$.post("../apps/monitoring-data.php", {"nomor_loket": nomor_loket}, function( data ){
					...
					//$("#init_max_queque").html('Antrian loket ' + data["loket"] +' kode dokter ' + data["kodedokter"]);						
