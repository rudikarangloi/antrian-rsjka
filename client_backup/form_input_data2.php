											...
											<tr>
												...
												<table border="0" width="100%">
													<tr>
														...
														$results = $mysqli->query('SELECT  * FROM client_antrian limit 3');
														$loket = 1;
													...
													<td>
														...
														$results = $mysqli->query('SELECT  * FROM client_antrian limit 3,20');
														$loket = 1;
														while ($row = $results->fetch_array()) {
...
<script languange="javascript">
	...
	$(document).ready(function(){
		$('#fSave').click(function(){
			...
			if(check){	
				//objfrm.submit();	
				swal("Silahkan Pilih Jenis Pasien.",{
				  buttons: {					
					roll: {
					  text: "Ibu Hamil",
					  value: "ibu_hamil",
				...
				.then((value) => {
				  switch (value) {
					...
					case "ibu_hamil":				  
					  //objfrm.CrSaveData.value="ibu_hamil";
					  //objfrm.submit();	

							//------------
							swal("Silahkan Pilih Bulan Kehamilan.",{
							  buttons: {					
								rolla: {
								  text: "Di bawah 5 bulan",
								  value: "Bawah",
								},
								roll2a: {
								  text: "Di atas 5 bulan",
								  value: "Atas",
								},								
							  },
							})
							.then((value) => {
							  switch (value) {
								...
								case "Bawah":		
                                  objfrm.CrSaveData.value="ibu_hamil";								
								  objfrm.CrSaveData2.value="Bawah";
								  objfrm.submit();					 
								  break;
								  
								case "Atas":	
                                  objfrm.CrSaveData.value="ibu_hamil";								
								  objfrm.CrSaveData2.value="Atas";
								  objfrm.submit();		  
								  break; 
					...
					case "anak_anak":						
					  objfrm.CrSaveData.value="anak_anak";
					  objfrm.submit();		  
					  break;
				...
				swal("Perhatian", "Silahkan Pilih Ruang Pemeriksaan");
