...
$("document").ready(function(){
	...
	console.log(' -> '+fNama);
	console.log(' -> '+fNik);
	console.log(' -> '+CrSaveData);
	  
    $.post( uri, {"loket" : loket,"nomor_rm": nomor_rm,"noBPJS": noBPJS,"noKTP": fNik,"jenis_antrian_poliklinik": jenis_antrian_poliklinik,"fAlamat": fAlamat,"fNama": fNama,"fNik": fNik,"fJnpK": fJnpK,"idPerusahaan": idPerusahaan,"nmPerusahaan": nmPerusahaan,"CrSaveData": CrSaveData} , function( data ) {
